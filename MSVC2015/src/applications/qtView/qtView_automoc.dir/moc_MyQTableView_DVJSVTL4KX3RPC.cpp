/****************************************************************************
** Meta object code from reading C++ file 'MyQTableView.h'
**
...
#include "../../../../../src/qtView/MyQTableView/MyQTableView.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MyQTableView.h' doesn't include <QObject>."
...
const QMetaObject MyQTableView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_MyQTableView.data,
      qt_meta_data_MyQTableView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
